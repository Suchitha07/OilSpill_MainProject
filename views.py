...
def upload(request):
    pathss = os.listdir(r"app\Dataset\oil_dataset\test")
    classes = []
    ...
    if request.method == 'POST':
        ...
        # if m==1:
        #     models = load_model(r"C:\Users\suchi\OneDrive\Desktop\Main Project\TK128335\TK128335\CODE\app\models\CNN.h5")
        #     x = image.load_img(path, target_size=(256, 256))

        if m==1:
            models = load_model(r"C:\Users\suchi\OneDrive\Desktop\Main Project\TK128335\TK128335\CODE\app\models\Mobilenet.h5")
            x = image.load_img(path, target_size=(256, 256))

        # if m==3:
        #     models = load_model(r"C:\Users\suchi\OneDrive\Desktop\Main Project\TK128335\TK128335\CODE\app\models\resnet.h5")
        #     x = image.load_img(path, target_size=(256, 256))
